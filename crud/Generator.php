...
namespace insolita\giitwig\crud;
...
class Generator extends \yii\gii\Generator
{
    ...
    public function generate()
    {
        ...
        foreach (scandir($templatePath) as $file) {
            if (empty($this->searchModelClass) && $file === '_search.twig') {
                continue;
            }
    ...
    public function generateActiveField($attribute)
    {
        ...
        if ($column->phpType === 'boolean') {
            ...
            if (is_array($column->enumValues) && count($column->enumValues) > 0) {
                ...
                return " form.field(model,\"$attribute\").dropDownList({}, {\"prompt\":\"\"})";
    ...
    /**
     * Generates a string for twig, prevent quotes
     * @return string
     */
    public function generateTString($string = '', $placeholders = [])
    {
